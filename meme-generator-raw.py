...
def generate_meme(image_path, font_path, top_text, bottom_text='',
                font_size=6,stroke_width=2, name=None, savePath=None):
    # load image
    ...
    # save meme
    dirMeme = os.path.dirname(os.path.realpath(__file__)) + '/generatedMeme/raw/'
...
if __name__ == '__main__':
    ...
    imagePath = scriptDir  + '/' + 'template.meme.catLook.png'
